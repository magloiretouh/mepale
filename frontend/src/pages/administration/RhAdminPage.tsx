 ...
 * Catégories d'employés · Types de primes · Taux sociaux CNSS/AMU
 */
...
const SELECT = cn(
  'w-full h-9 bg-[--bg-elevated] border border-[--border] rounded-lgtext-sm pl-3 pr-8',
    ...
    <div className="flex flex-col gap-5 animate-fade-in">
      ...
      <div style={{ marginBottom: 4 }}>
        ...
        <p className="text-sm mt-0.5" style={{ color: 'var(--text-secondary)' }}>
          Configuration des catégories, types de primes et taux sociaux.
        </p>
      </div>
